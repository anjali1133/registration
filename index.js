...
app.get('/submitsuccess.html', (req, res) => {        //get requests to the root ("/") will route here
    res.sendFile('submitsuccess.html', {root: __dirname});      //server responds by sending the index.html file to the client's browser
                                                        //the .sendFile method needs the absolute path to the file, see: https://expressjs.com/en/4x/api.html#res.sendFile
});
